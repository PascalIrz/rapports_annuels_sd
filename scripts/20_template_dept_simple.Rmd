...
dept_ipr %>%
  ...
  geom_line(data = reg_ope_ipr_mediane,
            aes(x = annee,
                y = ipr_med),
            col = "brown") +
    scale_fill_manual(values = c("Très bon" = "#1f78b4",
                               "Bon" = "#b2df8a",
                               "Moyen" = "#ffff33",
                                "Médiocre" = "#ff7f00",
                               "Mauvais" = "#e41a1c"),
